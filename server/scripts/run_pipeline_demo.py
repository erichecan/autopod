...
# The VTON Result from the Demo Run
VTON_IMAGE_PATH = "/Users/eric/.gemini/antigravity/brain/7791c775-bb52-4547-8010-6243cbca6b36/vton_neon_strict.png"

PROMPT = (
    "Cinematic Runway Walk. "
    "Bring this fashion model to life. "
    "The model executes a confident runway walk forward. "
    "The customized t-shirt design (Neon Colors Cyberpunk) must remain stable and clearly visible on the chest. "
    ...
    try:
        ...
        while True:
            ...
            if poll_data.get("done"):
                ...
                save_path = f"{save_dir}/final_neon_runway.mp4"
